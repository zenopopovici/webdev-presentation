...
export default function MemeSlide3({ contentVisible = true }: SlideProps) {
  return (
        ...
        {contentVisible ? (
          ...
          >
            <motion.img
              ...
              alt="Security meme"
              className="max-h-[75vh] rounded-lg shadow-2xl mx-auto"
            ...
            >
              Security is no joke... well, maybe a little 🔐
            </motion.p>
          </motion.div>
        ) : null}
      </AnimatePresence>
