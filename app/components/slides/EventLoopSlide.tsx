...
export default function EventLoopSlide() {
  ...
  return (
    <div className="w-full h-full flex flex-col p-16">
      <motion.div
        ...
        className="mb-6"
      >
        <span className="text-cyber-green font-display text-sm tracking-widest uppercase">Magia</span>
        <h1 className="text-5xl font-body font-bold mt-2">
          Bucla de <span className="text-cyber-green">Evenimente</span>
        </h1>
      </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="relative w-full max-w-5xl h-96">
          ...
          >
            <h4 className="text-cyber-cyan font-display font-semibold text-sm mb-3">📚 Stiva de Apeluri</h4>
          ...
          >
            ...
            <div className="space-y-1 text-xs font-display">
              ...
              <div className="px-2 py-1 bg-cyber-purple/20 rounded">Evenimente DOM</div>
            </div>
          </motion.div>
          ...
          >
            <h4 className="text-cyber-pink font-display font-semibold text-sm mb-3">📋 Coada de Task-uri</h4>
            <div className="space-y-1">
          ...
          >
            <h4 className="text-cyber-orange font-display font-semibold text-sm mb-3">⚡ Coada Microtask</h4>
            <div className="space-y-1 text-xs font-display">
            ...
            <p className="text-white/40 text-xs mt-2">Prioritate mai mare decât task-urile</p>
          </motion.div>
      ...
      >
        <p className="text-white/60 font-display text-sm max-w-2xl mx-auto">
          Bucla de evenimente verifică continuu dacă <span className="text-cyber-cyan">stiva de apeluri</span> este goală, 
          apoi procesează <span className="text-cyber-orange">microtask-urile</span> mai întâi, 
          apoi mută <span className="text-cyber-pink">callback-urile</span> din coadă în stivă.
        </p>
      </motion.div>
    </div>
  )
